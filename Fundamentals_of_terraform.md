...
Before getting started with terraform it is very important to understnad some key technologies and concepts. Here are the terms
...
Click on "your codespaces" as shown in the (https://github.com/iam-veeramalla/terraform-zero-to-hero/blob/main/Images/codespaces-location.png)
Codespaces will provide you a virtual machine with Ubuntu and VS Code by default.
Follow the steps provided in the Downloads (https://developer.hashicorp.com/terraform/downloads) for Linux.

**Linux**
Follow the steps provided in the Downloads https://developer.hashicorp.com/terraform/downloads for Linux.

**macOS**
Follow the steps provided in the Downloads https://developer.hashicorp.com/terraform/downloads for macOS.
